...
package com.ivianuu.essentials.ui.animation.three
...
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.Down
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.End
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.Left
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.Right
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.Start
import com.ivianuu.essentials.ui.animation.three.AnimatedStackScope.SlideDirection.Companion.Up
...
/**
 * [AnimatedStackScope] provides functions that are convenient and only applicable in the
 * context of [AnimatedStack], such as [slideIntoContainer] and [slideOutOfContainer].
 */
class AnimatedStackScope<T> internal constructor(
  ...
  private inner class SizeModifier @OptIn(InternalAnimationApi::class) constructor(
...
@OptIn(ExperimentalAnimationApi::class)
@Composable
fun <T> Transition<List<T>>.AnimatedStack(
  modifier: Modifier = Modifier,
  transitionSpec: AnimatedStackScope<T>.() -> ContentTransform = {
    fadeIn(animationSpec = tween(220, delayMillis = 90)) +
        scaleIn(initialScale = 0.92f, animationSpec = tween(220, delayMillis = 90)) with
  ...
  val currentlyVisible = remember(this) { currentState.toMutableStateList() }
  ...
  if (currentState.any { it !in contentMap } || targetState.any { it !in contentMap }) {
    contentMap.clear()
      ...
      contentMap[stateForContent] = {
        ...
        AnimatedVisibility(
          ...
          modifier = Modifier
            ...
            .then(AnimatedStackScope.ChildData(stateForContent in targetState))
        ) {
