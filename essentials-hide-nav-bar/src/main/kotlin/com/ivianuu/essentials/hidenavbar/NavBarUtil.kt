...
import com.ivianuu.essentials.android.settings.AndroidSettingFeatureModule
...
fun nonSdkInterfaceDetectionDisabler(
    ...
    @Given hiddenApiPolicyStore: Feature<HiddenApiPolicy, StoreAction<HiddenApiPolicy>>,
    @Given hiddenApiPolicyPrePieAppsStore: Feature<HiddenApiPolicyPieApps, StoreAction<HiddenApiPolicyPieApps>>,
    @Given hiddenApiPolicyPieAppsStore: Feature<HiddenApiPolicyPieApps, StoreAction<HiddenApiPolicyPieApps>>,
...
val hiddenApiPolicyModule =
    AndroidSettingFeatureModule<HiddenApiPolicy, Int>("hidden_api_policy", AndroidSettingsType.GLOBAL)
...
val hiddenApiPolicyPrePieAppsModule =
    AndroidSettingFeatureModule<HiddenApiPolicyPrePieApps, Int>("hidden_api_policy_pre_p_apps",
...
val hiddenApiPolicyPieAppsBinding =
    AndroidSettingFeatureModule<HiddenApiPolicyPieApps, Int>("hidden_api_policy_p_apps",
        AndroidSettingsType.GLOBAL)
