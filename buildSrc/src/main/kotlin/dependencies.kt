...
object Publishing {
    ...
    const val version = "${Build.versionName}-dev729"
}

object Deps {
    const val accompanistCoil =
        "dev.chrisbanes.accompanist:accompanist-coil:0.3.4.compose-6994167-SNAPSHOT"
    ...
    const val essentialsGradlePlugin =
        "com.ivianuu.essentials:essentials-gradle-plugin:0.0.1-dev728"

    const val firebaseCrashlytics = "com.google.firebase:firebase-crashlytics:17.2.2"

    object Injekt {
        private const val version = "0.0.1-dev410"
