...
val Icons.Rounded.Brightness4: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(22.6f, 11.29f)
        lineTo(20.0f, 8.69f)
        lineTo(20.0f, 5.0f)
        ...
        curveToRelative(0.05f, 0.33f, 0.07f, 0.66f, 0.07f, 0.98f)
        curveToRelative(-0.01f, 0.32f, -0.03f, 0.65f, -0.08f, 0.98f)
        close()
    }
}
