...
val Icons.Rounded.SettingsInputAntenna: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(12.0f, 5.0f)
        ...
        curveToRelative(-1.69f, -0.48f, -3.23f, 0.78f, -3.23f, 2.4f)
        ...
        curveToRelative(-0.05f, 0.59f, 0.41f, 1.1f, 1.0f, 1.1f)
