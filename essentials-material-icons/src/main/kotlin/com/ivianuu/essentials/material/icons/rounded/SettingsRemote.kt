...
val Icons.Rounded.SettingsRemote: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(15.0f, 9.0f)
        lineTo(9.0f, 9.0f)
        ...
        reflectiveCurveToRelative(2.07f, 0.34f, 2.88f, 0.91f)
        ...
        reflectiveCurveToRelative(4.16f, 0.77f, 5.7f, 2.04f)
