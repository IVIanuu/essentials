...
val Icons.Rounded.Eco: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(6.05f, 8.05f)
        ...
        curveToRelative(2.99f, -2.99f, 3.83f, -11.14f, 4.01f, -13.38f)
        curveToRelative(0.02f, -0.31f, -0.23f, -0.56f, -0.53f, -0.53f)
        curveTo(17.19f, 4.22f, 9.04f, 5.06f, 6.05f, 8.05f)
        close()
    }
}
