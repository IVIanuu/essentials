...
val Icons.TwoTone.SportsSoccer: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(7.01f, 9.49f)
        lineTo(11.0f, 6.7f)
        verticalLineTo(5.3f)
        lineTo(9.65f, 4.35f)
        curveTo(7.83f, 4.92f, 6.28f, 6.12f, 5.27f, 7.69f)
    ...
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        ...
        curveTo(4.01f, 11.77f, 4.0f, 11.88f, 4.0f, 12.0f)
        curveToRelative(0.0f, 1.99f, 0.73f, 3.81f, 1.94f, 5.21f)
    ...
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(18.34f, 9.03f)
        lineToRelative(0.39f, -1.34f)
        curveToRelative(-1.01f, -1.57f, -2.55f, -2.77f, -4.38f, -3.34f)
        lineTo(13.0f, 5.3f)
        verticalLineToRelative(1.4f)
        lineToRelative(3.99f, 2.79f)
        lineTo(18.34f, 9.03f)
        close()
    }
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
    ...
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        ...
        curveTo(10.29f, 19.85f, 11.13f, 20.0f, 12.0f, 20.0f)
    ...
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        ...
        lineToRelative(0.79f, 1.37f)
        lineToRelative(1.14f, 0.1f)
        curveTo(19.27f, 15.81f, 20.0f, 13.99f, 20.0f, 12.0f)
        curveTo(20.0f, 11.88f, 19.99f, 11.77f, 19.98f, 11.65f)
        close()
    }
    path {
        moveTo(12.0f, 2.0f)
