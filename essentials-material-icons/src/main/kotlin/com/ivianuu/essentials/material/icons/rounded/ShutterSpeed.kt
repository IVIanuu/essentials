...
val Icons.Rounded.ShutterSpeed: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(10.0f, 3.0f)
        ...
        curveToRelative(0.38f, 0.0f, 0.62f, -0.4f, 0.45f, -0.73f)
        ...
        curveToRelative(-0.39f, 0.0f, -0.63f, 0.4f, -0.45f, 0.74f)
        close()
