...
val Icons.Filled.ExploreOff: VectorAsset by lazyMaterialIcon {
    path {
        ...
        curveToRelative(0.31f, 0.0f, 0.62f, -0.02f, 0.92f, -0.05f)
        ...
        close()
        moveTo(6.0f, 18.0f)
        lineToRelative(3.0f, -6.46f)
        lineTo(12.46f, 15.0f)
        lineTo(6.0f, 18.0f)
        close()
        moveTo(22.0f, 12.0f)
        curveToRelative(0.0f, 0.31f, -0.02f, 0.62f, -0.05f, 0.92f)
