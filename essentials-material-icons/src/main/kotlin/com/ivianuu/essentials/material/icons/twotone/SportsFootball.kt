...
val Icons.TwoTone.SportsFootball: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(16.26f, 5.0f)
        curveToRelative(-0.35f, 0.0f, -0.8f, 0.01f, -1.33f, 0.06f)
        lineToRelative(4.03f, 4.03f)
        curveToRelative(0.14f, -1.63f, 0.01f, -3.07f, -0.17f, -3.86f)
        curveTo(18.28f, 5.12f, 17.4f, 5.0f, 16.26f, 5.0f)
        close()
    }
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(5.21f, 18.77f)
        curveTo(5.72f, 18.88f, 6.6f, 19.0f, 7.74f, 19.0f)
        curveToRelative(0.34f, 0.0f, 0.79f, -0.01f, 1.3f, -0.05f)
