...
val Icons.TwoTone.BugReport: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f) {
        moveTo(15.83f, 9.65f)
        lineTo(15.46f, 9.0f)
        ...
        curveTo(12.63f, 7.04f, 12.32f, 7.0f, 12.0f, 7.0f)
        curveToRelative(-0.31f, 0.0f, -0.63f, 0.04f, -0.94f, 0.11f)
    ...
    path {
        ...
        lineToRelative(-0.37f, -0.64f)
        lineToRelative(-0.1f, -0.65f)
        curveTo(8.03f, 15.47f, 8.0f, 15.22f, 8.0f, 15.0f)
        verticalLineToRelative(-4.0f)
        curveToRelative(0.0f, -0.22f, 0.03f, -0.47f, 0.07f, -0.7f)
        lineToRelative(0.1f, -0.65f)
        lineToRelative(0.37f, -0.65f)
