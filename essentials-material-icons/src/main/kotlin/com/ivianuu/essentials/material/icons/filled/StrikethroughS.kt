...
val Icons.Filled.StrikethroughS: VectorAsset by lazyMaterialIcon {
    group {
        path {
            moveTo(7.24f, 8.75f)
            ...
            curveToRelative(0.25f, 0.55f, 0.38f, 1.15f, 0.38f, 1.81f)
            ...
            curveToRelative(-0.29f, 0.09f, -0.53f, 0.21f, -0.72f, 0.36f)
            ...
            curveToRelative(-0.14f, -0.31f, -0.25f, -0.76f, -0.25f, -1.21f)
