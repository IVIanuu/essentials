...
val Icons.TwoTone.Loyalty: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f) {
        moveTo(11.0f, 4.0f)
        lineTo(4.0f, 4.0f)
        ...
        curveToRelative(0.37f, -0.37f, 0.89f, -0.6f, 1.45f, -0.6f)
        curveToRelative(1.13f, 0.0f, 2.05f, 0.92f, 2.05f, 2.05f)
        curveToRelative(0.0f, 0.57f, -0.23f, 1.08f, -0.6f, 1.45f)
        lineTo(13.0f, 17.5f)
        lineTo(9.5f, 14.0f)
        curveToRelative(-0.37f, -0.38f, -0.6f, -0.89f, -0.6f, -1.45f)
        curveToRelative(0.0f, -1.13f, 0.92f, -2.05f, 2.05f, -2.05f)
        curveToRelative(0.57f, 0.0f, 1.08f, 0.23f, 1.45f, 0.61f)
