...
val Icons.Rounded.SettingsPower: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(7.0f, 24.0f)
        ...
        curveToRelative(-0.41f, 0.41f, -0.36f, 1.08f, 0.08f, 1.46f)
        ...
        lineToRelative(-0.02f, -0.02f)
        curveToRelative(-0.37f, -0.37f, -0.96f, -0.39f, -1.36f, -0.04f)
        ...
        curveToRelative(-0.39f, -0.34f, -0.98f, -0.32f, -1.35f, 0.05f)
        close()
        moveTo(15.0f, 24.0f)
        horizontalLineToRelative(2.0f)
        verticalLineToRelative(-2.0f)
