...
val Icons.Rounded.LocalCarWash: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(17.0f, 5.0f)
        curveToRelative(0.83f, 0.0f, 1.5f, -0.67f, 1.5f, -1.5f)
        curveToRelative(0.0f, -0.66f, -0.66f, -1.64f, -1.11f, -2.22f)
        ...
        curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f)
        reflectiveCurveTo(6.0f, 22.33f, 6.0f, 21.5f)
        lineTo(6.0f, 21.0f)
