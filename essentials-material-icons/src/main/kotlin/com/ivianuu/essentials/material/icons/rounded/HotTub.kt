...
val Icons.Rounded.HotTub: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(7.0f, 6.0f)
    ...
    path {
        ...
        close()
        moveTo(15.06f, 10.0f)
        curveToRelative(0.5f, 0.0f, 0.93f, -0.39f, 0.94f, -0.89f)
        ...
        curveToRelative(-0.5f, 0.0f, -0.93f, 0.4f, -0.94f, 0.9f)
