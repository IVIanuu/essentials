...
val Icons.Rounded.NetworkLocked: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(22.0f, 16.0f)
        ...
        curveToRelative(0.0f, -0.92f, 0.42f, -1.74f, 1.07f, -2.3f)
        curveToRelative(0.38f, -2.1f, 2.22f, -3.7f, 4.43f, -3.7f)
        close()
    }
}
