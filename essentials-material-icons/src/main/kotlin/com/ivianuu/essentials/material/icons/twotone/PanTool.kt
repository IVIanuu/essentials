...
val Icons.TwoTone.PanTool: VectorAsset by lazyMaterialIcon {
    ...
    path {
        ...
        curveToRelative(-0.33f, 0.0f, -0.65f, 0.06f, -0.94f, 0.18f)
        curveTo(15.11f, 0.44f, 14.35f, 0.01f, 13.5f, 0.01f)
        curveToRelative(-1.32f, 0.0f, -2.41f, 1.03f, -2.49f, 2.33f)
        ...
        curveToRelative(-0.54f, 0.0f, -1.07f, -0.22f, -1.44f, -0.62f)
