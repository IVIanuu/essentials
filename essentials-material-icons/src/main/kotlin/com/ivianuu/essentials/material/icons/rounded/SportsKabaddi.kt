...
val Icons.Rounded.SportsKabaddi: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(16.5f, 2.38f)
    ...
    path {
        ...
        lineToRelative(-4.99f, -2.11f)
        curveToRelative(-0.98f, -0.41f, -2.12f, -0.07f, -2.71f, 0.81f)
        ...
        lineToRelative(1.62f, 7.19f)
        curveToRelative(0.11f, 0.47f, 0.53f, 0.81f, 1.02f, 0.81f)
        horizontalLineToRelative(0.0f)
        curveToRelative(0.66f, 0.0f, 1.15f, -0.6f, 1.02f, -1.24f)
        ...
        curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f)
        horizontalLineToRelative(0.0f)
        curveTo(23.55f, 11.88f, 24.0f, 11.43f, 24.0f, 10.88f)
        close()
    }
    path {
        moveTo(10.29f, 8.09f)
    ...
    path {
        ...
        lineToRelative(0.0f, 0.0f)
        curveToRelative(1.02f, 1.0f, 2.28f, 1.69f, 3.79f, 1.94f)
        curveToRelative(0.64f, 0.11f, 1.21f, -0.45f, 1.16f, -1.1f)
        verticalLineToRelative(0.0f)
        curveToRelative(-0.03f, -0.48f, -0.4f, -0.87f, -0.87f, -0.94f)
        curveTo(12.9f, 11.83f, 11.97f, 11.29f, 11.24f, 10.56f)
        close()
    }
}
