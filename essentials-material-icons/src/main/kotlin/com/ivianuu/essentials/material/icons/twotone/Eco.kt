...
val Icons.TwoTone.Eco: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(7.46f, 9.46f)
        curveTo(5.68f, 11.25f, 5.55f, 14.04f, 7.03f, 16.0f)
        curveToRelative(1.53f, -2.54f, 3.73f, -4.64f, 6.37f, -6.0f)
        curveToRelative(-2.26f, 1.91f, -3.95f, 4.44f, -4.88f, 7.32f)
        curveTo(9.27f, 17.75f, 10.11f, 18.0f, 11.0f, 18.0f)
