...
val Icons.Rounded.FormatShapes: VectorAsset by lazyMaterialIcon {
    path {
        moveTo(23.0f, 6.0f)
        lineTo(23.0f, 2.0f)
        ...
        curveToRelative(0.32f, 0.0f, 0.6f, -0.2f, 0.71f, -0.5f)
        ...
        curveToRelative(0.53f, 0.0f, 0.89f, -0.53f, 0.71f, -1.02f)
