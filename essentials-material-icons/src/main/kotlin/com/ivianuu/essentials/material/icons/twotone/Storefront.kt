...
val Icons.TwoTone.Storefront: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        ...
        curveTo(4.43f, 10.71f, 4.73f, 11.0f, 5.23f, 11.0f)
        curveTo(5.84f, 11.0f, 6.36f, 10.51f, 6.44f, 9.86f)
        close()
    }
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(9.71f, 11.0f)
        curveTo(10.45f, 11.0f, 11.0f, 10.41f, 11.0f, 9.69f)
        verticalLineTo(5.0f)
        horizontalLineTo(9.04f)
        lineTo(8.49f, 9.52f)
        curveToRelative(-0.05f, 0.39f, 0.07f, 0.78f, 0.33f, 1.07f)
        curveTo(9.05f, 10.85f, 9.37f, 11.0f, 9.71f, 11.0f)
        close()
    }
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(14.22f, 11.0f)
        curveToRelative(0.41f, 0.0f, 0.72f, -0.15f, 0.96f, -0.41f)
        curveToRelative(0.25f, -0.29f, 0.37f, -0.68f, 0.33f, -1.07f)
        lineTo(14.96f, 5.0f)
        horizontalLineTo(13.0f)
        verticalLineToRelative(4.69f)
        curveTo(13.0f, 10.41f, 13.55f, 11.0f, 14.22f, 11.0f)
        close()
    }
    path(fillAlpha = 0.3f, strokeAlpha = 0.3f) {
        moveTo(18.91f, 4.99f)
        lineTo(16.98f, 5.0f)
        lineToRelative(0.58f, 4.86f)
        curveToRelative(0.08f, 0.65f, 0.6f, 1.14f, 1.21f, 1.14f)
    ...
    path {
        ...
        curveTo(4.73f, 11.0f, 4.43f, 10.71f, 4.29f, 10.53f)
        close()
        moveTo(19.0f, 19.0f)
        ...
        lineToRelative(1.05f, 4.37f)
        curveTo(20.06f, 9.78f, 19.97f, 10.21f, 19.71f, 10.53f)
        close()
    }
}
