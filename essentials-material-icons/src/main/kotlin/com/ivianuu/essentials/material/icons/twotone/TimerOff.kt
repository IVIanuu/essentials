...
val Icons.TwoTone.TimerOff: VectorAsset by lazyMaterialIcon {
    path(fillAlpha = 0.3f) {
        moveTo(12.0f, 6.0f)
        curveToRelative(-1.12f, 0.0f, -2.18f, 0.27f, -3.12f, 0.74f)
        lineTo(11.0f, 8.86f)
        lineTo(11.0f, 8.0f)
        horizontalLineToRelative(2.0f)
        verticalLineToRelative(2.86f)
        lineToRelative(5.26f, 5.26f)
        curveToRelative(0.47f, -0.94f, 0.74f, -2.0f, 0.74f, -3.12f)
        curveToRelative(0.0f, -3.87f, -3.13f, -7.0f, -7.0f, -7.0f)
        close()
        moveTo(12.0f, 20.0f)
        curveToRelative(1.29f, 0.0f, 2.49f, -0.35f, 3.52f, -0.96f)
        lineTo(5.96f, 9.48f)
        curveTo(5.35f, 10.51f, 5.0f, 11.71f, 5.0f, 13.0f)
        curveToRelative(0.0f, 3.87f, 3.13f, 7.0f, 7.0f, 7.0f)
        close()
    }
    path {
