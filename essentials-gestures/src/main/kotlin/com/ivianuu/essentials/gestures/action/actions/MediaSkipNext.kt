...
fun skipNextMediaAction(mediaAction: mediaAction): Action = mediaAction(
    "media_skip_next",
...
@ActionSettingsKey("media_skip_next")
inline val MediaActionSettingsKey.skipNextMediaActionSettingsKey: MediaActionSettingsKey
    get() = this
