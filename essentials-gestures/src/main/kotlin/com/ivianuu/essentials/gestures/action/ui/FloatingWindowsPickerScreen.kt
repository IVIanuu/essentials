...
class FloatingWindowsPickerScreen(val actionTitle: String) : Screen<Boolean>

@Provide fun floatingWindowsPickerUi(
  commonStrings: CommonStrings
) = Ui<FloatingWindowsPickerScreen, FloatingWindowsPickerModel> { model ->
  Scaffold(
...
@Provide fun floatingWindowsPickerModel(
  ...
  navigator: Navigator,
  resources: Resources,
  screen: FloatingWindowsPickerScreen,
  toaster: Toaster
) = Model {
  FloatingWindowsPickerModel(
    actionTitle = screen.actionTitle,
    ...
    openFullScreen = action { navigator.pop(screen, false) }
  )
}
