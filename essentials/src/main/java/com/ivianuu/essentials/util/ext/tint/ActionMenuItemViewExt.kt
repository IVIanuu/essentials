...
import com.ivianuu.essentials.util.ColorStateListUtil
...
fun ActionMenuItemView.tint(activeColor: Int,
    ...
    try {
        ...
        iconField.set(this, icon.tintedNullable(ColorStateListUtil.getEnabledColorStateList(activeColor, inactiveColor)))
        setTextColor(ColorStateListUtil.getEnabledColorStateList(activeColor, inactiveColor))
    } catch (e: Exception) {
        e.printStackTrace()
    }
}