...
) = subscribeUi(this@LifecycleOwner2, event, onError, onComplete)
...
) = subscribeUi(this@LifecycleOwner2, event, onError, onComplete, onNext)
...
) = subscribeUi(this@LifecycleOwner2, event, onError, onComplete, onSuccess)
...
onError: (Throwable) -> Unit = onErrorStub,
onSuccess: (T) -> Unit = onNextStub
) = subscribeUi(this@LifecycleOwner2, event, onError, onSuccess)
