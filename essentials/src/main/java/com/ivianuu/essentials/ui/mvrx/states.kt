...
): G = block(viewModel1.peekState(), viewModel2.peekState(), viewModel3.peekState())
...
inline fun <A : MvRxViewModel<B>, B, C : MvRxViewModel<D>, D, E : MvRxViewModel<F>, F, G : MvRxViewModel<H>, H, I> withState(
    ...
    viewModel1.peekState(),
    viewModel2.peekState(),
    viewModel3.peekState(),
    viewModel4.peekState()
)
